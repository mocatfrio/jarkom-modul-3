...
4. Tambahkan syntax berikut
    ...
    * **default-lease-time 'Waktu'**: Default waktu yang diberikan DHCP server kepada client dalam menggunakan alamat IP yang diberikan
    * **max-lease-time 'Waktu'**: Waktu maksimal yang digunakan DHCP server untuk memberikan pembagian IP
